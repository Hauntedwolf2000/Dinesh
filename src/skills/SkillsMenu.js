...
import toolsIcon from "../assets/eagle-emblem.png"; // Import the icon for Developer Tools
...
export default class SkillsMenu extends Component {
  ...
  render() {
    ...
    const menuItems = ["FRONT-END", "BACK-END", "DEV-TOOLS"]; // Add "DEVELOPER TOOLS" to the menu items
    ...
    const currentIcon =
      activeMenuItem === 1
        ...
        ? backendIcon
        : toolsIcon;
        // Update to include the icon for "DEVELOPER TOOLS"
